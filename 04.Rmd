...
Using the data from the homework that we went over today, do a piecewise growth
curve model, with the discontinuity at week 26. I copy the previous description of the
data set below. Center time at week 66. Include the treatment x time interaction for
time during phase 1 and for time during phase 2. Include as many random effects as will
converge. Then repeat the analysis using a hyperbolic growth curve with as many
random effects as will converge. Which fits the data better, piecewise or hyperbolic? Be ready to interpret the results of both models. 
...
- `Weekc66ph2`: The effect of time on CPSSIE is not significant for participants in condition 0 (PCT) during the second phase.  The slope of improvement in CPSSIE for people in condition 0 (0 which means they’re not improving a lot). The change in symptoms over time is not significant over time, collapsed over the two conditions.
