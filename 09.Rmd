...
- `Indexc17`: The slope of increase in PANAS_NEG for participants in the PAT condition is significant.
  * Interaction is significant!
- `PAT0`: The difference between the two conditions in terms of PANAS_NEG is significant at the last assessment.  
- `Indexc17*PAT0`: The change in PANAS_NEG over time is significantly different between conditions, such that the rate of decrease in PANAS_NEG in the NAT condition is faster than the rate of decrease in PANAS_NEG in the PAT condition.
